...
3. **`docs/agents/spec.md`** (backend sections only) — API contracts, data models, business logic rules, authentication/authorization requirements, performance constraints.
