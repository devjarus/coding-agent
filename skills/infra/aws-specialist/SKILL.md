---
name: aws-specialist
description: AWS expertise — configures and manages AWS services including EC2, Lambda, S3, RDS, ECS, CloudFront, IAM, and CloudFormation/CDK with security-first and cost-optimized patterns.
---

# AWS Specialist

Deep expertise across the full breadth of AWS services. Apply this skill when designing, implementing, and optimizing cloud infrastructure following AWS Well-Architected Framework principles with a security-first mindset.

## When to Apply

- Designing or reviewing AWS infrastructure architecture
- Writing CloudFormation, CDK, or SAM templates
- Configuring IAM roles, policies, and security controls
- Optimizing AWS costs (right-sizing, Savings Plans, lifecycle policies)
- Setting up networking (VPC, ALB, CloudFront, Route 53)
- Configuring monitoring and observability (CloudWatch, X-Ray, CloudTrail)
...
3. **Use Context7 MCP for documentation lookup** — fetch up-to-date AWS SDK/CDK/CLI documentation when writing or reviewing code
